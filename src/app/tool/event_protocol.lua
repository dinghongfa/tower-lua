-- EventProtocol = class("EventProtocol", Component)

-- function EventProtocol:ctor()
--     self.event_list = {}
--     print('event_protocol >>>>> line = 5', self);
-- end

-- function EventProtocol:cleanup()
-- end
...
--         return
--     end
--     print('event_protocol >>>>> line = 16', self);
--     PrintTable(self.event_list)
...
--     print('event_protocol >>>>> line = 25', self);
